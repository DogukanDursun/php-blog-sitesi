...
<?php
		if ($_GET["yazi_duzenle"]=="bos"){
			...
			?>
			<div class="alert alert-success">
				<strong>Tebrikler!</strong> Silme işleminiz başarıyla gerçekleştirildi...
			</div>
			<?php
							...
							<tbody>
								...
								if($say){
									...
									<tr class="odd gradex">
										...
										<td> <img width="80" height="50" src="../img/yazilar/<?php echo $row["yazi_foto"];?>" alt="<?php echo $row ["yazi_baslik"]?>"></td>
