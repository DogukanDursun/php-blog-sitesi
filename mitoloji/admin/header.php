...
<link rel="Shortcut Icon"  href="Destan.ico"  type="image/x-icon">
    ...
    <link rel="Shortcut Icon"  href="../img/destan.ico"  type="image/x-icon">
</head>
<body>
	<section class="body">
		...
		<header class="header">
			<div class="logo-container">
				<a href="index.php" class="logo">
					<img src="../img/logo6.png" height="68px" width="352px" alt="Mitolojiler.com Admin" style="background-color: #333; margin-top: -8px; margin-left: -12px;" />
				</a>
				...
				<div id="userbox" class="userbox">
					<a href="#" data-toggle="dropdown">
						<figure class="profile-picture">
							<img src="ben.png" alt="Doğukan Dursun" class="img-circle" data-lock-picture="../img/ben.PNG" />
						</figure>
