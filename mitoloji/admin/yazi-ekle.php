			...
			<div class="panel-body">
				<form class="form-horizontal form-bordered" action="islem.php" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" name="yazi_baslik" class="form-control" placeholder="Yazınızın Başlığını giriniz">
						</div>
					</div>
					...
					<div >
						...
						<div class="col-md-9">
							<textarea rows="10" cols="80" name="yazi_icerik" class="ckeditor"><?php echo $yazi_cek["yazi_icerik"]; ?></textarea>
						</div>
					</div>
