...
<head>
	...
	<!-- Basic -->
	<meta charset="UTF-8">
	<title>Admin Giriş Sayfası - Mitolojilerle.Com</title>
					...
					<form action="islem.php" method="post">
						<div class="form-group mb-lg">
							...
							<div class="input-group input-group-icon">
								<input name="admin_kadi" type="text" class="form-control input-lg" placeholder="dogukan" />
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<?php } ?>
								<button type="submit" name="loggin" class="btn btn-block btn-primary">Giriş Yap</button>
							</div>
						</div>
